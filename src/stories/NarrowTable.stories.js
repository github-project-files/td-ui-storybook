...
import NarrowTable from '../components/narrow-table/NarrowTable'

export default {
    title: 'Example/NarrowTable',
    component: NarrowTable
}
const NarrowTableData = [
    {
        id: 1,
        heading: 'Client',
...
export const narrowTable = () => (
    <NarrowTable tableType='narrow' NarrowTableData={NarrowTableData} />
)
